...
<section class="content home">
        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                @endif
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0);"><i class="zmdi zmdi-blur-circular"></i> {{__('admin.nationalities')}}</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                {!! Form::open(['route'=>['nationalitiesdeleteall'],'method'=>'post','autocomplete'=>'off', 'id'=>'nationalitiess_form' ])!!}
                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown">
                                @can('nationality_create')
                                    ...
                                    <a href="{{route('addnationalitie')}}" class=" add-modal btn btn-success btn-round" title="{{trans('admin.add_nationalitie')}}">
                                        {{trans('admin.add_nationalitie')}}
                                    </a>
                                </li>
                                @endcan
                                ...
                                <tbody>
                                    ...
                                    <tr class="item{{$data->id}}">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('editnationalitie',$data->id)}}" class="btn btn-info waves-effect waves-float waves-green btn-round " title="{{trans('admin.edit')}}"><i class="zmdi zmdi-edit"></i></a>
                                            @endcan
                                            @can('nationality_delete')
    ...
    $(document).on('click', '.delete-modal', function() {
        ...
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    type: 'GET',
                    url: "<?php echo url('/')?>/nationalities/delete/" + id,
                    data: {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                if(choices.length >= 1){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '{{ URL::route("nationalitiesdeleteall") }}',
                        data:  new FormData($("#nationalitiess_form")[0]),
                        processData: false,
                        contentType: false,
                        success: function(data) {
