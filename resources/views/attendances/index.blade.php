...
<section class="content home">
        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                @endif
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0);"><i class="zmdi zmdi-face"></i> {{__('admin.attendances')}}</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                {!! Form::open(['route'=>['attendancesdeleteall'],'method'=>'post','autocomplete'=>'off', 'id'=>'attendancess_form' ])!!}
        ...
        id = $(this).data('id') ;
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        type: 'GET',
                        url: "<?php echo url('/')?>/attendances/delete/" + id,
                        data: {
                        ...
                        success: function(data) {
                            ...
                            window.location.replace("{{route('attendances')}}");
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                if(choices.length >= 1){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '{{ URL::route("attendancesdeleteall") }}',
                        data:  new FormData($("#attendancess_form")[0]),
                        processData: false,
                        contentType: false,
                        success: function(data) {
