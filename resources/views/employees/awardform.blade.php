        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                @endif
                    ...
                    <li class="breadcrumb-item"><a href="{{route('awards',$id)}}"><i class="zmdi zmdi-face"></i> {{__('admin.awards')}}</a></li>
                    <li class="breadcrumb-item "><a href="javascript:void(0);">
                            @if(!isset($data->id))                          
                            {{ trans('admin.add_award') }}
                            @else
                            {{ trans('admin.edit_award') }}
                            @endif                   
                         </a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="body row">
                        <div class="col-lg-10">
                                {!! Form::open(['route'=>['storeaward'],'method'=>'post','autocomplete'=>'off', 'name'=>"myform" ,'id'=>'form_validation', 'enctype'=>'multipart/form-data' ])!!} 
                                <div class=" row">
