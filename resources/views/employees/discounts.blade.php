...
<section class="content home">
        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                @endif
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0);"><i class="zmdi zmdi-face"></i> {{__('admin.discounts')}}</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                {!! Form::open(['route'=>['discountsdeleteall'],'method'=>'post','autocomplete'=>'off', 'id'=>'discountss_form' ])!!}
                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown">
                                    ...
                                    <a href="{{route('adddiscount',$id)}}" class=" add-modal btn btn-success btn-round" title="{{trans('admin.add_discount')}}">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    ...
                                                    <a href="{{route('editdiscount',$data->id)}}" class=" dropdown-item" title="Edit"> Edit </a> 
        ...
        id = $(this).data('id') ;
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        type: 'GET',
                        url: "<?php echo url('/')?>/employees/discounts/delete/" + id,
                        data: {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                if(choices.length >= 1){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '{{ URL::route("discountsdeleteall") }}',
                        data:  new FormData($("#discountss_form")[0]),
                        processData: false,
                        contentType: false,
                        success: function(data) {
