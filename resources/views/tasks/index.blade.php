...
<section class="content home">
        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                @endif
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0);"><i class="zmdi zmdi-face"></i> {{__('admin.tasks')}}</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                {!! Form::open(['route'=>['tasksdeleteall'],'method'=>'post','autocomplete'=>'off', 'id'=>'taskss_form' ])!!}
                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown">
                                    ...
                                    <a href="{{route('addtask')}}" class=" add-modal btn btn-success btn-round" title="{{trans('admin.add_task')}}">
                                        {{trans('admin.add_task')}}
                                    </a>
                                </li>
                                    ...
                                    @foreach ($tasks as $data)
                                     <tr class="item{{$data->id}}">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('edittask',$data->id)}}" class="btn btn-info waves-effect waves-float waves-green btn-round " title="{{trans('admin.edit')}}"><i class="zmdi zmdi-edit"></i></a>
        ...
        id = $(this).data('id') ;
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        type: 'GET',
                        url: "<?php echo url('/')?>/tasks/delete/" + id,
                        data: {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                if(choices.length >= 1){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '{{ URL::route("tasksdeleteall") }}',
                        data:  new FormData($("#taskss_form")[0]),
                        processData: false,
                        contentType: false,
                        success: function(data) {
