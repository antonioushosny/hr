        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                @endif
                    ...
                    <li class="breadcrumb-item "><a href="javascript:void(0);">{{__('admin.add_subscription')}}</a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="header">
                        <h2><strong>{{trans('admin.'.$title)}}</strong> {{trans('admin.add_subscription')}}  </h2>
                    ...
                    <div class="body row">
                        <div class="col-lg-6">
                            {!! Form::open(['route'=>['storeaddsubscription'],'method'=>'post','autocomplete'=>'off', 'id'=>'form_validation', 'enctype'=>'multipart/form-data' ])!!} 
                                ...
                                <div class="form-group form-float">
                                    <input type="number" class="form-control" min="1" max="12" placeholder="{{__('admin.placeholder_no_month')}}" name="no_month" required>
                                    <label id="no-month-error" class="error" for="no_month" style="">  </label>
                                </div>
                               
                               
                                <div class="form-group form-float">
                                    <input type="number" class="form-control" placeholder="{{__('admin.placeholder_cost')}}" name="cost" required>
