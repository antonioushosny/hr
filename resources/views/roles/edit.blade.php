                        ...
                        <div class="col-lg-12">
                            ...
                            {!! Form::hidden('id', $role->id, array('placeholder' => '','class' => 'form-control')) !!}
                                ...
                                <div class="form-group form-float">
                                    ...
                                    {!! Form::text('name', $role->name, array('placeholder' => __('admin.Name'),'class' => 'form-control')) !!}
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <label>{{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, array('class' => 'name check icheck')) }}
