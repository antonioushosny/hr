        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                @endif
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0);"><i class="zmdi zmdi-washing-machine"></i> {{__('admin.services')}}</a></li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown">
                                @can('service_create')
                                    ...
                                    <a href="{{route('addservice')}}" class=" add-modal btn btn-success btn-round" title="{{trans('admin.add_service')}}">
                                        {{trans('admin.add_service')}}
                                    </a>
                                </li>
                                @endcan
                                @can('service_delete')
