        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                ...
                @endif
                    ...
                    <li class="breadcrumb-item "><a href="javascript:void(0);">{{__('admin.showtechnicians')}}</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                ...
                {!! Form::open(['route'=>['servicesdeleteall'],'method'=>'post','autocomplete'=>'off', 'id'=>'servicess_form' ])!!}
                        ...
                        <div class="header">
                            <h2><strong>{{trans('admin.'.$title)}}</strong> {{trans('admin.showtechnicians')}} 
                            @if($lang=='en')
                            ({{$service->name_en}})
                            @else
                            ({{$service->name_ar}})
                        ...
                        <div class="body">
                            ...
                            @endif
                                ...
                                <tbody>
                                    @foreach ($service->fannies as $data)
                                    <tr class="item{{$data->id}}">
                                        
                                        <td>{{ $data->user->name }}</td>
                                        <td>{{ $data->user->mobile }}</td>
                                        @if($data->user->image)
                                        <td><img src="{{asset('img/').'/'.$data->user->image }}" width="50px" height="50px"></td>
                                        @else 
